          ...
          <motion.div style={{ opacity: scrollYProgress }}>
            <ContactSectionText>
              ...
              <Text color="grey2" type="body1">
                Quer transformar uma ideia em alguma solução? Entre em contato!
              </Text>
            </ContactSectionText>
          </motion.div>
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Estou disponível para um bate-papo, fique a vontade para
                  chamar.
                </Text>
                <Text
                  as="a"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                Podemos criar interações mais constantes, bem como um network.
                </Text>
                <Text
                  as="a"
                  color="grey2"
